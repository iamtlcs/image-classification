...
class VGG19(keras.Model):
    def __init__(self, input_shape = (227, 227, 3), activ_func_Conv2D = 'relu', activ_func_dense = 'relu', activ_func_output = 'softmax', num_classes = 8, **kwargs):
        ...
        self.Conv2D7 = keras.layers.Conv2D(filters=256, kernel_size=(3,3), activation=activ_func_Conv2D, padding="same", name="Block3_Conv4")
        self.MaxPool2D3 = keras.layers.MaxPool2D(pool_size=(2,2), strides=(2,2), name="Block3_pool")
        # Block 4
        self.Conv2D8 = keras.layers.Conv2D(filters=512, kernel_size=(3,3), activation=activ_func_Conv2D, padding="same", name="Block4_Conv1")
        self.Conv2D9 = keras.layers.Conv2D(filters=512, kernel_size=(3,3), activation=activ_func_Conv2D, padding="same", name="Block4_Conv2")
        self.Conv2D10 = keras.layers.Conv2D(filters=512, kernel_size=(3,3), activation=activ_func_Conv2D, padding="same", name="Block4_Conv3")
        self.Conv2D11 = keras.layers.Conv2D(filters=512, kernel_size=(3,3), activation=activ_func_Conv2D, padding="same", name="Block4_Conv4")
        self.MaxPool2D4 = keras.layers.MaxPool2D(pool_size=(2,2), strides=(2,2), name="Block4_pool")
        # Block 5
        self.Conv2D12 = keras.layers.Conv2D(filters=512, kernel_size=(3,3), activation=activ_func_Conv2D, padding="same", name="Block5_Conv1")
        self.Conv2D13 = keras.layers.Conv2D(filters=512, kernel_size=(3,3), activation=activ_func_Conv2D, padding="same", name="Block5_Conv2")
        self.Conv2D14 = keras.layers.Conv2D(filters=512, kernel_size=(3,3), activation=activ_func_Conv2D, padding="same", name="Block5_Conv3")
        self.Conv2D15 = keras.layers.Conv2D(filters=512, kernel_size=(3,3), activation=activ_func_Conv2D, padding="same", name="Block5_Conv4")
